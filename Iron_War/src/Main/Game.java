...
public class Game implements Runnable, Serializable{
	...
	public static final int 		BACKGROWND_COLOR=0xff0000ff;
	...
	//--------------------------------
	public ArrayList<Tank> rivalTank=new ArrayList<Tank>();
	private Tank 			rival;
	...
	public Game(boolean thisServer){
		...
		play=false;
		GameWindow.create(WIDTH, HEIGHT, TITLE, BACKGROWND_COLOR, STRATEGY_NUM);
	...
	public ArrayList<Tank> getRivalList(){
		return rivalTank;
	}
	public void setRivalList(ArrayList<Tank> tem){
